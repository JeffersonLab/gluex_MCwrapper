...
if ( "$GENR" != "0" ) then
    ...
    if ( "$GENERATOR" == "genr8" ) then
		...
		cp $CONFIG_FILE ./$STANDARD_NAME.py        else if ( "$GENERATOR" == "gen_gcf" ) then
