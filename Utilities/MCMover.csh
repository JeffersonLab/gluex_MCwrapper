...
if [[ `ps all -u tbritton | grep MCMover.csh | grep -v grep | wc -l` == 2 ]]; then
    ...
    echo ssh $LOGtransfer_node "cd $outputLOG_dir;find . -type f | sort > /tmp/outputLOG_files_list.txt; scp /tmp/outputLOG_files_list.txt tbritton@scosg16-ib:/tmp/outputLOG_files_list.txt"
    ssh $LOGtransfer_node "cd $outputLOG_dir;find . -type f | sort > /tmp/outputLOG_files_list.txt; scp /tmp/outputLOG_files_list.txt tbritton@scosg16-ib:/tmp/outputLOG_files_list.txt"
