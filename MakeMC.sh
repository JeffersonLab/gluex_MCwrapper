...
elif [[ "$GENERATOR_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
...
elif [[ "$POSTGEN_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
...
elif [[ "$SIMULATION_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
...
elif [[ "$MCSMEAR_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
...
if [[ "$GENERATOR" == "geantBEAM" ]]; then
	...
	if [[ "$GENR" != "0" && "$GEANT" != "0" && "$SMEAR" != "0" && "$RECON" != "0" ]]; then #run reconstruction
		...
		elif [[ "$RECON_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
		...
		if [[ "$ANAENVIRONMENT" != "no_Analysis_env" && "$reaction_filter" != "" || "$ANAENVIRONMENT" != "no_Analysis_env" && $ana_pre == "file" ]]; then #run analysis launch
			...
			elif [[ "$ANA_OS" == "ALMA9" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0-cntr" && "$runningOS" != "Linux_Alma9-x86_64-gcc11.5.0" ]]; then
